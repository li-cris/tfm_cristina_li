...
pert_data = PertData('../cris_test/data') # specific saved folder
pert_data.new_data_process(dataset_name = 'norman_old_pickle', adata = adata) # specific dataset name and adata object
pert_data.load(data_path = '../cris_test/data/norman_old_pickle') # load the processed data, the path is saved folder + dataset_name
