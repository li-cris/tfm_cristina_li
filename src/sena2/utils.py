...
class Norman2019DataLoader:
    def __init__(self, num_gene_th=5, batch_size=32, dataname="Norman2019_reduced"):
    ...
    def load_norman_2019_dataset(self):
        ...
        rel_dict, gene_dict, go_dict = self.build_gene_go_relationships(
    ...
    def build_gene_go_relationships(self, adata, gos, GO_to_ensembl_id_assignment):
        ...
        return rel_dict, gen_dict, go_dict
    ...
    def split_scdata(self, scdataset, split_ptbs, pct=0.2):
        ...
        train_idx = np.array([l for l in range(len(scdataset)) if l not in test_idx])  # noqa: E741
...
class LossFunction:
    def __init__(self, MMD_sigma: float, kernel_num: int, matched_IO: bool = False):
        """Initialize the LossFunction class with required parameters.
    ...
    def compute_loss(
        ...
        """Compute the losses: MMD, MSE, KL-divergence, and L1 regularization.
