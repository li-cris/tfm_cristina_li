...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=["double"],
        help="Which folds of SENA to evaluate (train, test and/or double). Currently works for double and test."
    )
...
def main(args: argparse.Namespace) -> None:
    """Main master function for evaluation on trained models only."""
    device = args.device
