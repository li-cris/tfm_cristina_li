...
from gears_tools.mmd_loss import MMDLoss # review
from gears_tools.kld_loss import compute_kld # review
from torch.utils.data import DataLoader



def path_check_and_load(data_path: str, model_path: str, ptb_path: str, config_path: str, mode: str, savedir: str) -> None:
...
def evaluate_model(model, dataloader, ptb_genes, config, results_dir_path: str, device: str, run_name: str, numint: int = 2) -> None:
    """Evaluate the model on the dataloader and save the results."""
